...
param pCoreEncryptionKeyVaultName = 'kv-encrypt-core-29022024'
...
param pProdSqlServerName = 'sql-prod-${pLocation}-001-29022024'
param pDevSqlServerName = 'sql-dev-${pLocation}-001-29022024'
param pProdSqlDatabaseName = 'sqldb-prod-${pLocation}-001'
param pDevSqlDatabaseName = 'sqldb-dev-${pLocation}-001'
param pProdStName = 'stprod00129022024'
param pDevStName = 'stdev00129022024'
